...
//implementare controllo data per visualizzare solo film con uscita superiore alla data di oggi
...
if(json.results[elem].release_date > now && json.results[elem].poster_path !=null ){
...
for(let i=1;i<6;i++){
const api_url='https://api.themoviedb.org/3/movie/upcoming?language=en-US&page='+i ;
